  ...
  const cloudServices = [
    {
      ...
      description: "Comprehensive cloud infrastructure monitoring, automation, and optimization services.",
    ...
    },
    {
      ...
      title: "FinOps",
      description: "Optimize cloud costs and enhance resource utilization with our FinOps practices.",
    ...
    },
    {
      ...
      description: "Protect your cloud infrastructure with comprehensive security solutions and compliance frameworks.",
    ...
    },
    {
      ...
      description: "Seamlessly move your workloads to AWS, Azure, or Google Cloud with minimal disruption and maximum value.",
    ...
    },
    {
      ...
      description: "Modernize your applications with Docker and Kubernetes orchestration for improved scalability.",
      gradientFrom: "from-pink-50",
    ...
    },
    {
      ...
      description: "Develop and implement effective multi-cloud approaches tailored to your business needs.",
      gradientFrom: "from-blue-50",
      gradientTo: "to-teal-50",
      path: "/services/cloud-solutions"
    },
    {
      ...
      description: "Managed cloud services with predictable pricing and ongoing optimization.",
      gradientFrom: "from-purple-50",
