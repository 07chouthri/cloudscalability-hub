          ...
          <div className="container mx-auto px-4 md:px-8">
            ...
            <div className="text-center mb-10 md:mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-black mb-4">
                ...
                <span className="text-gray-800">'s true potential</span>
              </h2>
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6">
              ...
              <div className="w-full md:w-[30%] min-w-[280px]">
                <div
                  ...
                  className="cursor-pointer flex items-center gap-2 text-pink-500 font-medium text-lg px-4 md:px-5 py-3 md:py-4 rounded-lg transition duration-300 ease-in-out hover:bg-pink-50"
                >
