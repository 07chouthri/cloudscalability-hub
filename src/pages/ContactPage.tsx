...
const ContactPage = () => {
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const formValues = {
      ...
      data: {
        ...
        service: formData.get('Interested Service')?.toString() ?? '',
    ...
    try {
      const response = await fetch(lambdaUrl, {
        ...
        body: JSON.stringify(formValues),  // send all form values
      });
      if (response.ok) {
        toast({
          title: "Message Sent",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="mt-10 flex-grow pt-10">
        {/* Hero Section */}
                ...
                <div className="space-y-6 md:space-y-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Need urgent support? Call us directly at <br />
                        <span className="font-medium text-hads-teal">+91 72040 26426</span>
                        <br /><span className="font-medium text-hads-teal tracking-[0.03em]">+91 81220 15654</span></p>
                    </div>
                  </div>
