...
const StatsSection = () => {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="relative py-20 overflow-hidden bg-gradient-to-br from-hads-dark via-hads-purple to-hads-dark"
    >
      ...
      <div className="container max-w-7xl mx-auto px-4 relative z-10">
        <h2 className={cn(
          ...
          <span className="bg-gradient-to-r from-hads-teal to-blue-400 bg-clip-text text-transparent animate-bounce-subtle">
            Cloud Hads
          </span>
        </h2>
          ...
          >
            ...
            <div className="w-full h-full pt-8">
              <h3 className="text-6xl font-bold text-blue-400 mb-3 text-center mt-2 group-hover:scale-110 transition-transform duration-300">
                <Counter end={400} duration={1000} delay={200} suffix="+" isInView={isInView} /> {/* Faster counter */}
              </h3>
