      ...
      <div className="container max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-14">
          {["Cloud Certified", "Tailored Solutions", "24/7 Support", "Business Impact"].map((label, idx) => (
            <Badge
              key={idx}
              className="px-5 py-2 bg-gradient-to-r from-hads-teal to-hads-purple text-white text-sm font-medium rounded-full shadow-md hover:scale-105 hover:shadow-xl transition-all duration-300 animate-pulse"
            >
              {label}
            </Badge>
          ))}
        ...
        <div className="text-center">
          <Button
            size="lg"
            className="bg-gradient-to-r from-hads-purple to-hads-teal text-white rounded-full px-8 py-4 text-lg font-semibold shadow-xl hover:scale-105 hover:shadow-2xl transition-transform"
          >
