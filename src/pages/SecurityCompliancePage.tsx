...
import SecurityandCompliancevieod from "../viedo/Security and Compliances.mp4";
      ...
      <main className="flex-grow pt-20">
        ...
        <section>
          ...
          >
            ...
            >
              <source src={SecurityandCompliancevieod} type="video/mp4" />
            ...
            >
              ...
              >
                Security and compliance are critical for <br/> protecting your business in the cloud.
                We help <br/> you follow the right rules, keep your data safe ,<br/> and avoid risks.
                From strong access controls <br/>to regular audits, we make sure your cloud <br/> setup is secure,
                reliable, and meets industry  <br/>standards. Stay safe, stay compliant, and focus <br/>on growth
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto mb-12 text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                ...
                <span className="text-hads-pink">Comprehensive</span>
                <span className="text-gray-800"> Security Solutions</span>
              </h2>
              <p className="text-lg text-gray-700 mb-8">
                Our security and compliance services protect your data, applications, and infrastructure
                while ensuring regulatory compliance across your entire cloud environment.
              </p>
            </div>
              ...
              <div className="flip-card h-80">
                <div className="flip-card-inner">
                  <div className="flip-card-front bg-white rounded-lg shadow-md p-8 flex flex-col items-center justify-center border border-gray-100">
                    ...
                    <h3 className="text-xl font-semibold mb-2 text-gray-900">Identity & Access Management</h3>
                    <p className="text-gray-700 text-center">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto mb-12 text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Enhanced Security Capabilities</h2>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto mb-12 text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Our Security Process</h2>
              <p className="text-lg text-gray-700">
            ...
            <div className="relative max-w-5xl mx-auto">
              <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-hads-teal via-hads-purple to-hads-pink"></div>

              {/* Step 1 */}
              <div className="relative z-10 mb-12">
                <div className="flex items-center">
                  <div className="w-1/2 pr-8 md:pr-12 text-right">
                    <h3 className="text-xl font-bold text-hads-purple mb-2">Assessment</h3>
                    <p className="text-gray-700">Comprehensive evaluation of your current security posture and identification of vulnerabilities</p>
                  </div>
              ...
              <div className="relative z-10 mb-12">
                <div className="flex items-center">
                  ...
                  <div className="flex-shrink-0 w-12 h-12 rounded-full border-4 border-white bg-gradient-to-r from-hads-purple to-hads-teal flex items-center justify-center shadow-lg">
                    <span className="text-white font-bold">2</span>
                  </div>
                  <div className="w-1/2 pl-8 md:pl-12">
                    <h3 className="text-xl font-bold text-hads-teal mb-2">Planning</h3>
                    <p className="text-gray-700">Developing tailored security strategies and roadmaps based on your business needs</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative z-10 mb-12">
                <div className="flex items-center">
                  <div className="w-1/2 pr-8 md:pr-12 text-right">
                    <h3 className="text-xl font-bold text-hads-purple mb-2">Implementation</h3>
                    <p className="text-gray-700">Deploying security solutions and integrating with your existing systems</p>
                  </div>
                  <div className="flex-shrink-0 w-12 h-12 rounded-full border-4 border-white bg-gradient-to-r from-hads-teal to-hads-pink flex items-center justify-center shadow-lg">
              ...
              <div className="relative z-10">
                <div className="flex items-center">
                  <div className="w-1/2 pr-8 md:pr-12"></div>
                  <div className="flex-shrink-0 w-12 h-12 rounded-full border-4 border-white bg-gradient-to-r from-hads-pink to-hads-purple flex items-center justify-center shadow-lg">
                    <span className="text-white font-bold">4</span>
                  </div>
                  <div className="w-1/2 pl-8 md:pl-12">
                    <h3 className="text-xl font-bold text-hads-pink mb-2">Monitoring & Optimization</h3>
                    <p className="text-gray-700">Continuous monitoring, threat detection, and security optimization</p>
                  </div>
                </div>
              </div>
            </div>
