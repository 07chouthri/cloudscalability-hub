      ...
      <div className="container max-w-7xl mx-auto px-4 relative z-10">
        <div className="mb-6 md:mb-12 lg:mb-16">
          <div className="flex items-center">
            <div className="h-px w-6 md:w-8 lg:w-12 bg-hads-pink mr-2 md:mr-4"></div>
            <h2 className={cn(
          ...
          <p className={cn(
            "text-xs sm:text-sm md:text-base text-gray-600 mt-2 md:mt-4 max-w-3xl transition-all duration-400 delay-100 transform",
            isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          )}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-6 lg:gap-8">
          {partners.map((partner, index) => (
            ...
            >
              ...
              <p className="text-xs md:text-sm text-gray-600 text-center">{partner.description}</p>
            </div>
          ))}
        </div>
      </div>
