  ...
  return (
    <section ref={sectionRef} className="bg-white py-24 relative overflow-hidden">
      ...
      {/* <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-hads-dark via-hads-purple/20 to-hads-dark opacity-50"></div>
      ...
      <div className="container max-w-7xl mx-auto px-4 relative z-10">
        <div className="mb-16 text-center">
          ...
          <p className={cn(
            ...
            HADS is your trusted partner for cloud migration, application development,
            and data analytics. We help businesses leverage modern cloud technologies
            to achieve scalability, reliability, and cost efficiency.
          </p>
        </div>
