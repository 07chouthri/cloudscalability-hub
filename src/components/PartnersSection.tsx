  ...
  const partners = [
    {
      name: "AWS",
      logo: aws,
      description: "Premier Consulting Partner with expertise in cloud migration, DevOps, and security",
      ...
      <div className="container max-w-7xl mx-auto px-4 relative z-10">
        <div className="mb-16">
          ...
          <h3 className={cn(
            ...
            <span className='mx-2 text-hads-pink'>Our industry</span>
            partnerships
          </h3>
          ...
          <p className={cn(
            ...
            Through 25+ powerful industry alliances and partnerships, we give you access to best-in-class infrastructure for hybrid & multi-cloud operations.
          </p>
        </div>
